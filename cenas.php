...
<head>
    ...
    <title>Cenas Balanceadas - Easy Foods</title>
    ...
    <main class="recipes-grid">
        ...
        <article class="recipe-card">
            ...
            <div class="recipe-content">
                ...
                <p class="recipe-description">Pollo jugoso con una salsa cítrica y acompañamiento de vegetales al vapor.
                </p>
        ...
        <article class="recipe-card">
            ...
            <div class="recipe-content">
                <h2 class="recipe-title">Filete de Tilapia al Ajillo con Arroz</h2>
                <div class="recipe-meta">
                    <span>25 min</span>
